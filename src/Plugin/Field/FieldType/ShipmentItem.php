...
use Drupal\commerce_shipping\ShipmentItem as ShipmentItemObject;
...
class ShipmentItem extends FieldItemBase {
  ...
  public function isEmpty() {
    return $this->value === NULL || !$this->value instanceof ShipmentItemObject;
  }
  ...
  public function setValue($values, $notify = TRUE) {
    ...
    if (!$values instanceof ShipmentItemObject) {
      $values = NULL;
    }
